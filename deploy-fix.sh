...
# Update ProductCard to be fully clickable
...
echo "✅ ProductCard updated - entire card now clickable"
...
echo ""
echo "🚀 Pushing to Git & deploying to Vercel..."
git add -A
git commit -m "feat: make entire product card clickable to open details"
git checkout main
git merge backup-branch -m "merge: product card clickable"
